        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <p className="text-xl mb-4">
              Please login to create and view posts
            </p>
            <a
              href="/login"
  ...
  return (
    <div className={`pt-[10%] ${theme ? "bg-gray-50" : "bg-[#010101"}`}>
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Create Post Form */}
        <div
          className={`max-w-2xl mx-auto border-[1px] p-6 rounded-lg mb-8 ${
            theme
            ...
            <div>
              <input
                ...
                className={`w-full p-3 rounded-lg border focus:outline-none focus:ring-2 ${
                  theme
                    ? "bg-white border-gray-300 text-gray-900 focus:border-pink-700 focus:ring-pink-200"
                    : "bg-[#222222] border-[#444444] text-white focus:border-pink-700 focus:ring-pink-900/50"
                }`}
                required
              />
            </div>
