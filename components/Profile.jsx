          ...
          {auth ? (
            <>
              <div className="w-full sm:mt-5 sm:mb-5 mt-5 text-[14px] flex items-center justify-center font-bold">
                {isEditing ? (
                  <input
                    className={`bg-transparent border-[2px] border-pink-700 focus:border-green-700 focus:outline-none text-center rounded-lg w-[70%] sm:w-full p-1 sm:p-3`}
                    value={name}
                ...
                <button
                  ...
                  className={`${
                    isEditing
                      ...
                      : `${colors.keyColorBg} hover:bg-pink-800`
            ...
            {auth ? (
              <div>
                <div className="w-full mt-5 mb-5 flex items-center justify-center font-bold text-[20px]">
                  {isEditing ? (
                    <input
                      className={`bg-transparent border-[2px] border-pink-700 focus:border-green-700 focus:outline-none text-center rounded-lg w-full p-3`}
                      value={name}
                      onChange={(e) => setName(e.target.value)}
                    />
                  ) : (
