  ...
  return (
    ...
    >
      ...
      <FaArrowUp
        ...
        className="absolute bottom-5 right-5 cursor-pointer hover:text-white hover:border-[1px] hover:bg-pink-800 text-pink-800 border-[1px] border-pink-800 rounded-full p-1 text-[25px] sm:text-[25px] hover:cursor-pointer"
      />
    </div>
  );
}
